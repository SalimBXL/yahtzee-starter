...
const threeOfKind = new SumDistro({ count: 3, description: "Sum all dice if thee are the same" });
const fourOfKind = new SumDistro({ count: 4, description: "Summa all dice if four are the same" });
